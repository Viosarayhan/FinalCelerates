...
<<<<<<< HEAD
                        <img src="/assets/Karier.svg" alt="" className="w-[147px] h-[147px]"/>
=======
                        <img src="public/assets/Karier.svg" alt="" className="w-[147px] h-[147px]"/>
>>>>>>> 60826ca8337b8ef7f20482db1e4c5bc786bb5e83
...
>>>>>>> 60826ca8337b8ef7f20482db1e4c5bc786bb5e83
                        ...
                        <img src="/assets/Portfolio.svg" alt="" className="w-[147px] h-[147px]"/>
                ...
                <div name="Program Kami" className="flex justify-center mt-[60px] bg-[#4C37EE] items-center gap-[32px] flex-col w-auto h-fit shadow-xl pb-[40px] mx pt-[20px]">
                    ...
                    <div className="flex mx-[150px] w-[1140px] gap-[20px] items-center justify-center">
                        ...
                        <motion.div
                            ...
                            >
                            <img src="/assets/RakaPoster.jpg" alt="" className="w-[195px] -mr-[150px]"/>
                            </motion.div>
                            <motion.div
                            ...
                            >
                                <img src="/assets/TiaraPoster.jpg" alt="" className="w-[195px] z-10 -mr-[150px] "/>
                            </motion.div>
                            <motion.div
                            className="w-[195px]"
                            initial={{
                            ...
                            >
                                <img src="/assets/NadiaPoster.jpg" alt="" className="w-[195px]"/>
                            </motion.div>
                        </div>
                    ...
                    <div className="flex w-[1140px] gap-[20px] justify-between mt-10">
                        ...
                        <motion.div
                            ...
                            >
                            <img src="/assets/elearning back 1.jpg" alt="" className="w-[195px]"/>
                            </motion.div>
                            <motion.div
                            ...
                            >
                                <img src="/assets/elearning front.jpg" alt="" className="w-[195px] z-10 "/>
                            </motion.div>
                            <motion.div
                            ...
                            >
                                <img src="/assets/elearning back 2.jpg" alt="" className="w-[195px]"/>
                            </motion.div>
                    ...
                    <div className="flex w-[1140px] gap-[20px] justify-between">
                        ...
                        <motion.div
                            ...
                            >
                            <img src="/assets/artikel back1.jpg" alt="" className="w-[195px] -mr-[150px]"/>
                            </motion.div>
                            <motion.div
                            className="w-[195px] z-10 -mr-[150px]"
                            initial={{
                            ...
                            >
                                <img src="/assets/artikel front.jpg" alt="" className="w-[195px] z-10 -mr-[150px] "/>
                            </motion.div>
                            <motion.div
                            className="w-[195px]"
                            initial={{
                            ...
                            >
                                <img src="/assets/artikel back2.jpg" alt="" className="w-[195px]"/>
                            </motion.div>
